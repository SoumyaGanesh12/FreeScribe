...
export default function HomePage(props) {
    ...
    async function startRecording(){
        ...
        try{
            // Requests for microphone access of the user
    ...
    useEffect(() => {
        // Clock on the screen to get the duration of recording
    ...
    <main className='flex-1 p-4 flex flex-col gap-3 sm:gap-4 justify-center text-center pb-20'>
        ...
        <h3 className='font-medium md:text-lg'>
            {/* Html entity for right arrow - &rarr; */}
        ...
        {/* Record button */}
        <button onClick={recordingStatus === 'recording' ? stopRecording : startRecording} className='flex px-4 py-2 rounded-xl items-center text-base justify-between gap-4 mx-auto 
        w-72 max-w-full specialBtn my-4'>
