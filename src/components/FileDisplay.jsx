...
export default function FileDisplay(props) {
    ...
    return (
        ...
        <h1 className='font-semibold text-5xl sm:text-5xl md:text-6xl'>Your <span className='text-blue-400 bold'>File</span></h1>
        ...
        <div className='flex flex-col mb-2'>
            {/* Displays the audio with controls - play/pause/volume buttons */}
        ...
        <div className='flex items-center justify-between gap-4'>
            ...
            <button onClick={handleFormSubmission} className='specialBtn px-3 p-2 rounded-lg text-blue-400 flex items-center gap-2 '>
                <p>Transcribe</p>
